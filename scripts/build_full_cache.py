...
def main() -> None:
    ...
    # 1) Fill missing RAW prices via EODHD (covers delisted).
    ...
    # 2) Fill missing EDGAR facts (get_shares_outstanding fetches + caches).
    ...
    # 3) FORCE-recompute the whole grid (delete first so nothing is skipped).
    ...
    # 4) True Top-100 union + rebuild seed_cache.
