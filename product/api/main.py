...
class BacktestParams(BaseModel):
    ...
    trailing_stop_pct: float = 0.0         # 0 = disabled; e.g. 25 = exit 25% below peak/trough
    short_mode:       bool  = False         # True = short the signal instead of going long
